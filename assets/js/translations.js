...
const translations = {
  ...
  bn: {
    /* Brand & Nav */
    brandName: "WebWorldBD",
    developerName: "শাফাএত হোসেন ছারিফ",
    ...
    heroSubtitle: "হ্যালো! আমি শাফাএত হোসেন ছারিফ। আপনার ব্যবসার সাফল্যের জন্য দ্রুতগতিসম্পন্ন, আল্ট্রা-রেসপনসিভ ওয়েবসাইট, ওয়েব অ্যাপ এবং মোবাইল অ্যাপ তৈরি করি।",
    ...
    /* Footer */
    footerDesc: "শাফাএত হোসেন ছারিফ — WebWorldBD। গুণমান ও নীতিতে কোনো আপস না করে তৈরি করি শক্তিশালী ওয়েবসাইট ও মোবাইল অ্যাপ।",
    quickLinksTitle: "কুইক লিঙ্ক",
    servicesListTitle: "জনপ্রিয় সার্ভিসসমূহ",
    contactTitle: "যোগাযোগের ঠিকানা",
    copyrightText: "© ২০২৬ WebWorldBD। সর্বস্বত্ব সংরক্ষিত শাফাএত হোসেন ছারিফ দ্বারা।"
  }
};
